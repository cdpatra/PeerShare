...
//    };
   ...
   return (
    <Link to={`/dashboard/ai-summarizer/${playlistId}`} className="flex flex-col items-center w-full gap-4 p-4 transition-all duration-300 ease-in-out transform bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-90">
