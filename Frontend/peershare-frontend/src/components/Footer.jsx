...
export default function Footer() {
   return (
      <div id="footer" className="flex flex-col items-center gap-8  sm:flex-row bg-gray-950 p-4 justify-between">
         ...
         <div className="inline-grid justify-items-center order-1 sm:order-none">
            ...
            <div className="copyright text-slate-400 mt-4 scale-75">
               Copyright &copy; {new Date().getFullYear()} PeerShare | All rights reserved
            </div>
         </div>
         <div className="sm:basis-1/3 md:basis-1/5 text-center">
